...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("NumberActivity", "Words at index 0: " + words.get(0));
        Log.v("NumberActivity", "Words at index 1: " + words.get(1));
        Log.v("NumberActivity", "Words at index 2: " + words.get(2));
        Log.v("NumberActivity", "Words at index 3: " + words.get(3));
        Log.v("NumberActivity", "Words at index 4: " + words.get(4));
        ...
        Log.v("NumberActivity", "Words at index 9: " + words.get(9));
    }
}
